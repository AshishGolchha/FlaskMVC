...
def resource(url,controller,app):
    ...
    get(f"/{url}/<id>/edit",controller.edit,f"{url}.edit",app)
    post(f"/{url}/<id>",controller.update,f"{url}.update",app)
    post(f"/{url}/<id>/delete",controller.delete,f"{url}.delete",app)